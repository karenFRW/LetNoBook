...
public class CStudent {
    ...
    public CStudent(int f學生編號, String f學生姓名, int fClassId){
        this.f學生編號 = f學生編號;
        this.f學生姓名 = f學生姓名;
        this.fClassId = fClassId;
    }
    public CStudent(int f學生編號, String f學生姓名, String f學生生日, String f學生密碼, boolean f學生性別, int fClassId, String f身份區分, int f家庭編號) {
        super();
        this.f學生編號 = f學生編號;
        this.f學生姓名 = f學生姓名;
        this.f學生生日 = f學生生日;
