...
public class CtTeacher {
    ...
    public CtTeacher(int f老師編號, String f老師姓名, String f老師密碼){
        this.f老師編號 = f老師編號;
        this.f老師姓名 = f老師姓名;
        this.f老師密碼 = f老師密碼;
    }

    public CtTeacher(int f老師編號, String f老師姓名, String f老師生日, String f老師密碼, boolean f老師性別, String f身份區分) {
        super();
        this.f老師編號 = f老師編號;
        this.f老師姓名 = f老師姓名;
        this.f老師生日 = f老師生日;
